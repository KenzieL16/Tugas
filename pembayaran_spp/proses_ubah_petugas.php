...
if($_POST){
        ...
        if(empty($nama)){
            ...
            include "connect.php";
            $update=mysqli_query($connect,"update petugas set nama='".$username."', nama_petugas='".$nama."',alamat='".$alamat."', level='".$level."' where id_petugas = '".$id."'") or die(mysqli_error($connect));
            if($update){
